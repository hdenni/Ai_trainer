...
#         print('width: %d, height: %d' % (workout.get(3), workout.get(4))) # 영상의 너비와 높이 출력
        ...
        out15 = cv2.VideoWriter(f'result_{com_path[-4:-1]}_fps15.webm', fourcc, 15.0, (1280, 720)) # VideoWriter 객체 정의
        out06 = cv2.VideoWriter(f'result_{com_path[-4:-1]}_fps6.webm', fourcc, 6.0, (1280, 720)) # VideoWriter 객체 정의
